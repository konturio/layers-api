...
@DisplayName("GET /layers/collections/{collectionId}/items")
public class CollectionsItemsListGetIT extends AbstractIntegrationTest {
    ...
    public void featuresShouldMatchSpec() throws Exception {
        ...
        assertThat(json, hasJsonPath("$.links[?(@.rel=='self' && @.type=='application/geo+json')].href",
                anyOf(contains(url(BASE_URL + "/layers/collections/pubId_1/items?limit=10&offset=0")),
                        contains(url(BASE_URL + "/layers/collections/pubId_1/items")))));
        ...
        assertThat(json, hasJsonPath("$.features[0].links[?(@.rel=='self' && @.type=='application/geo+json')].href",
                contains(url(BASE_URL + "/layers/collections/pubId_1/items/featureId_1"))));
        assertThat(json,
                hasJsonPath("$.features[0].links[?(@.rel=='collection' && @.type=='application/geo+json')].href",
                        contains(url(BASE_URL + "/layers/collections/pubId_1"))));
    }
    ...
    public void paginationShouldWork() throws Exception {
        ...
        assertThat(json, hasJsonPath("$.links[?(@.rel=='next' && @.type=='application/geo+json')].href",
                contains(url(BASE_URL + "/layers/collections/pubId_1/items?limit=10&offset=20&prop1=*&prop2=*"))));
        assertThat(json, hasJsonPath("$.links[?(@.rel=='prev' && @.type=='application/geo+json')].href",
                contains(url(BASE_URL + "/layers/collections/pubId_1/items?limit=10&offset=0&prop1=*&prop2=*"))));
        assertThat(json, hasJsonPath("$.timeStamp", matchesRfc3339DatePattern()));
    ...
    public void noNextLinkIfNoMoreItems() throws Exception {
        ...
        assertThat(json, hasJsonPath("$.links[?(@.rel=='next' && @.type=='application/geo+json')].href", empty()));
        assertThat(json, hasJsonPath("$.links[?(@.rel=='prev' && @.type=='application/geo+json')].href",
                contains(url(BASE_URL + "/layers/collections/pubId_1/items?limit=10&offset=10"))));
        assertThat(json, hasJsonPath("$.timeStamp", matchesRfc3339DatePattern()));
        assertThat(json, hasJsonPath("$.numberMatched", is(25)));
...
//    public void bboxShouldRestrictResponseByGeometry() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        testDataMapper.insertFeature(id, buildPolygonN(1));
...
//
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items").queryParam("bbox", "3,3,4,4")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
...
//    public void responseForInvalidQueryParamShouldBeCorrect() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        testDataMapper.insertFeature(id, buildPolygonN(1));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items").queryParam("limit", "opop")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
...
//
//    @Test
//    @DisplayName("If you ask for 50000, you might get up to 1500 (server-limited) and if there are more, a next link;")
//    public void serverLimit1500() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        IntStream.rangeClosed(0, 199).forEach(value -> {
//            final List<Feature> features = IntStream.rangeClosed(1, 1001)
//                    .mapToObj(i -> buildPolygonN(value * 10000 + i))
//                    .collect(Collectors.toList());
//            testDataMapper.insertFeatures(id, features);
//        });
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items").queryParam("limit", 500000)
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
//        assertThat(json, hasJsonPath("$.numberMatched", is(200200)));
//        assertThat(json, hasJsonPath("$.numberReturned", is(100000)));
//        assertThat(json, hasJsonPath("$.links[?(@.rel=='next' && @.type=='application/geo+json')].href",
//                                     contains(BASE_URL + "/layers/collections/pubId_1/items?limit=100000&offset=100000")));
//    }
//
//    @Test
...
//        testDataMapper.insertFeature(id, buildPolygonN(1));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items").queryParam("offset", -1)
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
...
//    public void pointFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        testDataMapper.insertFeature(id, buildPointN(1));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
...
//    public void geometryCollectionFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void lineStringFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void multiLineStringFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void multiPointFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void multiPolygonFeatureShouldMatchSpec() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//                new DateTimeRange(lastUpdated.minusSeconds(1), lastUpdated.plusSeconds(1))));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .request(MediaType.APPLICATION_JSON_TYPE)
...
//    public void nullFieldsMustBeSkipped() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void nextLinkShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        IntStream.rangeClosed(1, 25).forEach(i -> testDataMapper.insertFeature(id, buildPolygonN(i)));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items").queryParam("limit", 10)
//                .resolveTemplate("collectionId", layer.getPublicId())
...
//
//        final Response resp = newClient().target(URI.create(nextLinks.get(0)))
//                .request(APPLICATION_JSON_TYPE).get();
//        //THEN
//        final String s = assertStatusAndReadBody(resp, OK);
...
//    public void exactMatchPropertyFilterShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        testDataMapper.insertFeature(id, buildPolygonN(1));
...
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
//        assertThat(response.getMediaType(), is(MediaType.valueOf(APPLICATION_GEO_JSON)));
//        assertThat(json, hasJsonPath("$.numberMatched", is(1)));
//        assertThat(json, hasJsonPath("$.numberReturned", is(1)));
//        assertThat(json, hasJsonPath("$.features", hasSize(1)));
...
//    public void sqlLikePatternEscaped() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//
...
//    public void fieldInPropFilterMustAppearNotMoreThenOnce() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        testDataMapper.insertFeature(id, buildPolygonN(1));
...
//    public void propertyFiltersCombinedWithAnd() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void wildcardPropertyFilterShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        IntStream.rangeClosed(1, 21).forEach(i -> {
...
//    public void missingPropertyShouldNotBeIgnored() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void dateTimeParameterShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        final Feature feature1 = buildPolygonN(1);
...
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .queryParam("datetime", feature1.getDatetime().getFrom() + "/" + feature2.getDatetime().getTo())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
...
//    public void dateTimeParameterOpenEndShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        final Feature feature1 = buildPolygonN(1);
...
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .queryParam("datetime", feature2.getDatetime().getFrom() + "/..")
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
...
//    public void dateTimeParameterOpenStartShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        final Feature feature1 = buildPolygonN(1);
...
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .queryParam("datetime", "../" + feature2.getDatetime().getTo())
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
...
//    public void dateTimeDoubleOpenEndedShouldFail() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
...
//    public void dateTimeValidationShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        testDataMapper.insertLayer(layer);
//        //WHEN
...
//    public void dateTimeExactMatchShouldWork() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        final Feature feature1 = buildPolygonN(1);
//        final OffsetDateTime someDate = OffsetDateTime.of(2020, 4, 15, 15, 30, 0, 0, offset());
//        feature1.setDatetime(new DateTimeRange(someDate, someDate));
//        testDataMapper.insertFeature(id, feature1);
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .queryParam("datetime", someDate)
//                .request(MediaType.APPLICATION_JSON_TYPE)
//                .get();
//        //THEN
//        final String json = assertStatusAndReadBody(response, OK);
...
//    public void dateTimeStartShouldBeBeforeEnd() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final OffsetDateTime someDate = OffsetDateTime.of(2020, 4, 15, 15, 30, 0, 0, offset());
//        //WHEN
...
//    public void emptyGeometryIsValidCase() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//    public void zCoordForBboxParam() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
...
//
//    @Test
//    @DisplayName("empty datetime is valid case as per requirement (C. in /req/core/fc-bbox-response )")
//    public void emptyDatetimeIsValidCase() {
//        //GIVEN
//        final Layer layer = buildLayerN(1);
//        final long id = testDataMapper.insertLayer(layer);
//        final OffsetDateTime someDate = OffsetDateTime.of(2020, 4, 15, 15, 30, 0, 0, offset());
//        final OffsetDateTime lastUpdated = someDate.plusMinutes(10);
//        testDataMapper.insertFeature(id, new Feature(null, "featureId_" + 10, null, null, lastUpdated, null));
//        //WHEN
//        final Response response = webClient.path("/layers/collections/{collectionId}/items")
//                .resolveTemplate("collectionId", layer.getPublicId())
//                .queryParam("datetime", someDate)
