...
public class CollectionsItemsApi {
    ...
    public CollectionsItemsApi(FeatureService featureService,
                               HttpServletRequest servletRequest) {
        this.featureService = featureService;
        this.servletRequest = servletRequest;
    }

    @GetMapping(value = "/{featureId}", produces = APPLICATION_GEO_JSON)
    ...
    @GetMapping(produces = APPLICATION_GEO_JSON)
    ...
    @PostMapping(value = "/search", produces = APPLICATION_GEO_JSON)
